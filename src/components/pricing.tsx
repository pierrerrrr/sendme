...
export default function Pricing() {
    return (
        <section className="py-16 md:py-32 text-foreground">
            <div className="mx-auto max-w-6xl px-6">
                <div className="mx-auto max-w-2xl space-y-6 text-center">
                    <h1 className="text-center text-4xl font-semibold">Pricing that Scales with You</h1>
                ...
                <div className="mt-8 grid gap-6 md:mt-20 md:grid-cols-3">
                    ...
                    <Card className="flex flex-col">
                        <CardHeader>
                            ...
                            <span className="my-3 block text-2xl font-semibold">R$0,00/mo</span>
                    ...
                    <Card className="relative bg-card text-card-foreground border-border shadow-card-dark-subtle dark:shadow-card-dark-lg
                        ...
                        <CardHeader>
                            ...
                            <span className="my-3 block text-2xl font-semibold">R$100,00/mo</span>
                    ...
                    <Card className="flex flex-col bg-card text-card-foreground border-border shadow-card-dark-subtle dark:shadow-card-dark-lg">
                        <CardHeader>
                            <CardTitle className="font-medium">Smart AI</CardTitle>

                            <span className="my-3 block text-2xl font-semibold">R$149,99/mo</span>
